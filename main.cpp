...
//Function that draws stick man on gallows for each wrong guess.
...
int main() {
    ...
    while (playAgain) {
        ...
        while (!endGame) {
            ...
            //If a wrong guess is made, this is displayed for the user. A new value is assigned to stickManNum to help StickMan know what to print.
            if (wrongGuess) {
            ...
            wrongGuess = true;
            cout << "---" << endl << "  |" << endl;
            //Function call prints stick man on gallows
...
//Function to have Stick Figure on gallows
void StickMan(int& num){
    if(num == 1) {
        cout << "  O" << endl;
    }
